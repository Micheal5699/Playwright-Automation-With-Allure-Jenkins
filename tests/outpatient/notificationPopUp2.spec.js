...
test("TC2.001 Check In patient ", async ({ page }) =>
{
         ...
         await page.getByRole('option', { name: 'Ophthalmology' }).click();
         ...
         const locator = page.getByRole('heading', { name: 'Select section' });
         await expect(locator).toBeVisible();
         await page.locator('.modal--confirm__body > .tw-relative > .form__select > .modal-select__control > .modal-select__value-container > .modal-select__input-container').click();
