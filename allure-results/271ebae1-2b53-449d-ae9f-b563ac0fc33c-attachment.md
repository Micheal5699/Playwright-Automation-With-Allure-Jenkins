                  ...
                  - generic [ref=e134]:
                    ...
                    - generic [ref=e138]:
                      - generic [ref=e142]:
                        ...
                        - text: ":"
                        - generic [ref=e144]: 36m
                        - text: ":"
                        - generic [ref=e145]: 50s
          ...
          - generic [ref=e970]:
            - generic [ref=e974]:
              - generic [ref=e976]:
                ...
                - generic [ref=e979]:
                  - log [ref=e981]: Use Up and Down to choose options, press Enter to select the currently focused option, press Escape to exit the menu, press Tab to select the option and exit the menu.
                  - generic [ref=e982]:
                    - generic [ref=e983]:
                      - generic [ref=e984]: Start typing to search...
                      - combobox [expanded] [active] [ref=e986]
                    - img [ref=e989]
                  - listbox [ref=e992]:
                    - generic [ref=e993]: No options
              - generic [ref=e995]:
                - paragraph [ref=e997]: Dosage
                - generic [ref=e998]:
                  - generic [ref=e1000]:
                    - generic [ref=e1001]: Dose
                    - textbox "0" [ref=e1003]
                  - generic [ref=e1005]:
                    - generic [ref=e1007]: Unit
                    - generic [ref=e1008]:
                      - log [ref=e1010]
                      - generic [ref=e1011]:
                        - generic [ref=e1012]:
                          - generic [ref=e1013]: Select Option
                          - combobox [ref=e1015]
                        - img [ref=e1018]
                  - generic [ref=e1021]:
                    - generic [ref=e1023]: Route
                    - generic [ref=e1024]:
                      - log [ref=e1026]
                      - generic [ref=e1027]:
                        - generic [ref=e1028]:
                          - generic [ref=e1029]: Select Option
                          - combobox [ref=e1031]
                        - img [ref=e1034]
                  - generic [ref=e1037]:
                    - generic [ref=e1039]: Frequency
                    - generic [ref=e1040]:
                      - log [ref=e1042]
                      - generic [ref=e1043]:
                        - generic [ref=e1044]:
                          - generic [ref=e1045]: Select Option
                          - combobox [ref=e1047]
                        - img [ref=e1050]
                  - generic [ref=e1053]:
                    - generic [ref=e1055]: Duration(In Days)
                    - generic [ref=e1056]:
                      - log [ref=e1058]
                      - generic [ref=e1059]:
                        - generic [ref=e1060]:
                          - generic [ref=e1061]: Select Option
                          - combobox [ref=e1063]
                        - img [ref=e1066]
                  - generic [ref=e1069]:
                    - generic [ref=e1071]: Extra Dosage Instructions
                    - textbox "Enter here" [ref=e1072]
                  - button "+ Add Breakdown" [disabled] [ref=e1074]:
                    - generic [ref=e1075]: + Add Breakdown
                  - generic [ref=e1077]:
                    - generic [ref=e1078]: Dosage Summary
                    - textbox "Summary shows up here" [disabled] [ref=e1079]
              - generic [ref=e1084] [cursor=pointer]: Create appointment drug chart
              - generic [ref=e1086]:
                - generic [ref=e1087]:
                  - generic [ref=e1088]: Doctor
                  - generic [ref=e1089]: "*"
                - generic [ref=e1090]:
                  - log [ref=e1092]
                  - generic [ref=e1093]:
                    - generic [ref=e1094]:
                      - generic [ref=e1095]: Adeolu1 Ogungbesan
                      - combobox [ref=e1097]
                    - img [ref=e1100]
              - generic [ref=e1102]:
                - button " Add Item" [disabled] [ref=e1103]:
                  - generic [ref=e1104]: 
                  - generic [ref=e1105]: Add Item
                - button " Clear Input" [ref=e1106] [cursor=pointer]:
                  - generic [ref=e1107]: 
                  - generic [ref=e1108]: Clear Input
            - generic [ref=e1109]:
              - button "Submit" [disabled] [ref=e1110]
              - button "Print" [ref=e1112] [cursor=pointer]:
                - img
                - generic [ref=e1113]: Print
```